package com.wrupple.muba.desktop.client.widgets.impl;
...
public class ProcessWindowImpl implements ProcessWindow {
    ...
    public ProcessWindowImpl() {
        ...
        interact setRuntimeContext the underlying Screen that backs the GUI directly, as it might modify the screen in a way the
        GUI isn't aware of.
        ...
        try {
            ...
            /*
            There are a couple of different constructors to MultiWindowTextGUI, we are going to go setRuntimeContext the defaults for
            most of these values. The one thing to consider is threading; setRuntimeContext the default options, lanterna will use
            ...
            Lanterna to create a dedicated UI thread and not lock the caller. Just like setRuntimeContext AWT and Swing, you should
            ...
            /*
            The window has no content initially, you need to call setComponent to populate it setRuntimeContext something. In this
             ...
             * which is based on the layout manager setRuntimeContext the same name in SWT. In the constructor above we have
             * specified that we want to have a grid setRuntimeContext two columns, below we customize the layout further by adding
            ...
            /*
            Close off setRuntimeContext an empty row and a separator, then a button to close the window
             */
            contentPanel.addComponent(
                    new EmptySpace()
                            .setLayoutData(
            ...
            /*
            We now have the content panel fully populated setRuntimeContext components. A common mistake is to forget to attach it to
