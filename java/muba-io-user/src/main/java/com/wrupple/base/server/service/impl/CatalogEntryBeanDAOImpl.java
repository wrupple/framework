...
public class CatalogEntryBeanDAOImpl extends AbstractJDBC_DAO<CatalogEntry> implements CatalogEntryBeanDAO {
	...
	private CatalogPropertyAccesor accessor;
	private Session session;

	@Inject
	public CatalogEntryBeanDAOImpl(DataSource ds,/*SingleDomainClassTableNameService*/ CatalogTableNameService tableNames, @Named("catalog.datePattern") String  formatt, CatalogPropertyAccesor accessor,@Named("system.multitenant") Boolean multitenant,@Named("domainField") String domainField) {
