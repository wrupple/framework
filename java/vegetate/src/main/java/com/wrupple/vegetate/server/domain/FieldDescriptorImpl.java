...
public class FieldDescriptorImpl implements CatalogEntry, FieldDescriptor {
	...
	private String fieldId,description,help, name, widget, defaultValue, command, ownerCatalogId, foreignCatalogName, formula;
	private Long foreignCatalog,id;
	...
	public FieldDescriptorImpl makeKey(String id,
		...
		setFilterable(true);
		setKey(true);
		setForeignCatalogName(foreign_catalog);
		setFieldId(id);
	...
	public void setForeignCatalogName(String foreignCatalog) {
		this.foreignCatalogName = foreignCatalog;
	}
	@Override
	public String getForeignCatalogName() {
		return foreignCatalogName;
	}
	...
	public String toString() {
		return "[dataType=" + dataType + ", fieldId=" + fieldId + ", name=" + name + ", widget=" + widget + ", foreignCatalogName="
				+ foreignCatalogName + ", multiple=" + multiple + "]";
	}
