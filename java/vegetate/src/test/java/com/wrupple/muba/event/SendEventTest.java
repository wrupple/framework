...
public class SendEventTest extends MubaTest {
    ...
    public SendEventTest() {
        super();
        init(new MockModule(), new ValidationModule(), new LambdaModule(), new DispatcherModule(), new DispatcherModule(), new ApplicationModule());
    }

    protected void registerServices(EventBus server, EventBus client) {
        ...
        server.getIntentInterpret().registerService(multiply, new UpdatedVersionService() {
        ...
        server.getIntentInterpret().registerService(addInt, new OldVesionService() {
        ...
        server.getIntentInterpret().registerService(addDouble, new UpdatedVersionService() {
        ...
        client.getIntentInterpret().registerRemoteService(host, channel, multiply.getServiceId());
        client.getIntentInterpret().registerRemoteService(host, channel, addInt.getServiceId());
        client.getIntentInterpret().registerRemoteService(host, channel, addDouble.getServiceId());
    ...
    public void setUp() throws Exception {
        runtimeContext = new RuntimeContextImpl(serverInjector.getInstance(EventBus.class), serverInjector.getInstance(Key.get(ContainerContext.class, Names.named(SYSTEM))));
