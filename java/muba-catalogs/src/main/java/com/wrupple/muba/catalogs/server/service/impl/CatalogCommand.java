...
public abstract class CatalogCommand implements CatalogTransaction {

	protected static final Logger log = LoggerFactory.getLogger(CatalogCommand.class);
	...
	public CatalogCommand(CatalogQueryRewriter queryRewriter, Provider<CatalogResultCache> cacheProvider,
