...
public class AssembleEditorImpl implements AssembleEditor {

    private final ContentManagementSystem cms;

    @Inject
    public AssembleEditorImpl(ContentManagementSystem cms, TransactionPanelMap transactionPanelMap,
