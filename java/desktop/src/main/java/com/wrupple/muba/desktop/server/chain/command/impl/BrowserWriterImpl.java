...
public class BrowserWriterImpl implements BrowserWriter {
	...
	private void writeSingleEntrySubmission(DesktopBuilderContext context, PrintWriter writer, FieldDescriptor field, CatalogEntry submitted, String submitUrl,
	...
	private void writeFile(DesktopBuilderContext context, VegetateUrlServiceBuilder catalogUrlBuilder, PrintWriter writer, CatalogEntry entry,
