...
public class FormWriterImpl extends AbstractSingleCatalogEntryWriter implements FormWriter {
	...
	@Override
	protected void writeForeignValue(PrintWriter writer, DesktopBuilderContext context, CatalogDescriptor catalog, CatalogEntry parentEntry,
	...
	@Override
	protected void writeFile(DesktopBuilderContext context, VegetateUrlServiceBuilder catalogUrlBuilder, PrintWriter writer, CatalogEntry parentEntry,
	...
	@Override
	protected void writeFooter(DesktopBuilderContext context, ProcessTaskDescriptor task, CatalogDescriptor catalog, PrintWriter writer, CatalogEntry entry) {
		writer.println("<input type=\"submit\" value=\"Ok\">");
		writer.print("<input type=\"hidden\" name=\"");
		writer.print(DesktopRequestReader.SUBMITTING_TASK);
		writer.print(" value=\"");
	...
	@Override
	protected void writeHeader(DesktopBuilderContext context, ProcessTaskDescriptor task, CatalogDescriptor catalog, PrintWriter writer, CatalogEntry entry) {
		if (entry != null) {
			writer.println("<h1>");
