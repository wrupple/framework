...
public interface FilterToolbar extends Toolbar {
	...
	public void addCriteria(FilterCriteria criteria,FieldDescriptor field, boolean fireEvents);

	public void setModelAlterationTarget(String attribute);

	public void setHideNewCriteriaButton(String attribute);
