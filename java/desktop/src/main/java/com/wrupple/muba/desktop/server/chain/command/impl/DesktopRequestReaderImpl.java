...
import com.wrupple.muba.catalogs.server.service.DesktopSliceWriter;
...
public class DesktopRequestReaderImpl implements DesktopRequestReader {
	...
	public boolean execute(Context c) throws Exception {
		...
		String submittingTaskId = (String) context.getRequest().getParameter(DesktopRequestReader.SUBMITTING_TASK);
