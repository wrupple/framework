...
public interface ObjectMapper {
	...
	Map<String, Object> readMap(String serializedPayload,ContractDescriptor catalog) throws IOException;

	Map<String, Object> readMap(InputStream inputStream,ContractDescriptor catalog)throws IOException;
