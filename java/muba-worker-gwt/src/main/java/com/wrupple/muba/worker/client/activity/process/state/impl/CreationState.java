...
public class CreationState extends AbstractUserInteractionState {
    private final ContentManagementSystem cms;

    @Inject
    public CreationState(ContentManagementSystem cms, TransactionPanelMap transactionPanelMap,
