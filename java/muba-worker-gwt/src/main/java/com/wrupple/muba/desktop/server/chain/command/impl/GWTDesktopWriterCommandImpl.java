...
public class GWTDesktopWriterCommandImpl  implements GWTDesktopWriterCommand {
	...
	public boolean execute(Context context) throws Exception {
		DesktopBuilderContext parameter =(DesktopBuilderContext) context;
	...
	private void writeHead(PrintWriter writer, DesktopBuilderContext parameter, DomainSystemProperties system,
		...
		if (system.getActivityPresenterToolbarHeight() != null) {
			writeMetaProperty(writer, ContentPanel.ActivityPresenterToolbarHeight, system.getActivityPresenterToolbarHeight());
		}
	...
	private void writeBody(PrintWriter writer, DesktopBuilderContext parameter) {
		if (parameter.isInternetExplorer()) {
			writer.print(
