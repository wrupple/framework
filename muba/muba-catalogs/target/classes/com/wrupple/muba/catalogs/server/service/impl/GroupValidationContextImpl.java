...
/**
 * 
 * FIXME Figure out how to custom validate without reimplementing this class (valant copy-paste with one crutial change from apache's b-val) .
 * Description: instance per validation process, not thread-safe<br/>
 */
public final class GroupValidationContextImpl<T> extends BeanValidationContext<ConstraintValidationListener<T>> implements
